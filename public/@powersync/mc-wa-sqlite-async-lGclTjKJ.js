var e = async function (e = {}) {
   ...
   function z() {
      return n.locateFile
         ? ((e = "mc-wa-sqlite-async.wasm"), n.locateFile ? n.locateFile(e, d) : d + e)
         : new URL("assets/mc-wa-sqlite-async-DYagSq56.wasm", globalThis.location.href).href;
      var e;
   }
   async function N(e) {
      if (!f)
   ...
   var X = () => kr(),
      ...
      K = (e, r) => {
         ...
         return Y.decode(v.subarray(e, n));
      },
      J = {
         isAbs: (e) => "/" === e.charAt(0),
         splitPath: (e) =>
      ...
      ee = (e, r = 0, t = NaN) => {
         ...
         return Y.decode(e.buffer ? e.subarray(r, i) : new Uint8Array(e.slice(r, i)));
      },
      re = [],
      te = (e) => {
      ...
      oe = {
         ...
         default_tty_ops: {
            ...
            put_char(e, r) {
               null === r || 10 === r
                  ? (k(ee(e.output)), (e.output = []))
                  : 0 != r && e.output.push(r);
            },
            fsync(e) {
               e.output?.length > 0 && (k(ee(e.output)), (e.output = []));
            },
            ioctl_tcgets: (e) => ({
               c_iflag: 25856,
               c_oflag: 5,
   ...
   var _e = [],
      ...
      ke = () => G || we > 0,
      Se = (e) => {
         ((p = e), ke() || (n.onExit?.(e), (C = !0)), _(0, new L(e)));
      },
      Ce = (e, r) => {
         ((p = e), Se(e));
      },
   ...
   var Te = function () {
      ...
      ((n.setCallback = (e, t) => r.set(e, t)),
         ...
         (Te = function (t, n, ...i) {
            const o = r.get(n);
            let a = null;
            const s = "function" == typeof o ? o : o[(a = K(i.shift()))];
            if (t) {
      ...
      _r = (e, r, t, n, i) => {
         ...
         function f(e) {
            return (
               ...
               0 !== l && Er(l),
               (function (e) {
                  return "string" === r ? K(e) : "boolean" === r ? Boolean(e) : e;
               })(e)
            );
         }
         var m = i?.async;
         ...
         a: (e, r, t, n) =>
            R(
               `Assertion failed: ${K(e)}, at: ` +
                  [r ? K(r) : "unknown filename", t, n ? K(n) : "unknown function"],
            ),
         aa: function (e, r) {
            try {
   ...
   (pr.ra,
      (n._powersync_init_static = pr.sa),
      (n._memcpy = pr.ta),
      (n._memset = pr.ua),
      (n._memcmp = pr.va),
      (n._sqlite3_status64 = pr.wa),
      (n._sqlite3_status = pr.xa),
      (n._sqlite3_msize = pr.ya),
      (n._sqlite3_db_status = pr.za),
      (n._sqlite3_vfs_find = pr.Aa),
      (n._sqlite3_vfs_register = pr.Ba),
      (n._sqlite3_vfs_unregister = pr.Ca),
      (n._sqlite3_release_memory = pr.Da),
      (n._sqlite3_soft_heap_limit64 = pr.Ea),
      (n._sqlite3_memory_used = pr.Fa),
      (n._sqlite3_hard_heap_limit64 = pr.Ga),
      (n._sqlite3_memory_highwater = pr.Ha),
      (n._sqlite3_malloc = pr.Ia),
      (n._sqlite3_malloc64 = pr.Ja),
      (n._sqlite3_free = pr.Ka),
      (n._sqlite3_realloc = pr.La),
      (n._sqlite3_realloc64 = pr.Ma),
      (n._sqlite3_str_vappendf = pr.Na),
      (n._sqlite3_str_append = pr.Oa),
      (n._sqlite3_str_appendchar = pr.Pa),
      (n._sqlite3_str_appendall = pr.Qa),
      (n._sqlite3_str_appendf = pr.Ra),
      (n._sqlite3_str_finish = pr.Sa),
      (n._sqlite3_str_errcode = pr.Ta),
      (n._sqlite3_str_length = pr.Ua),
      (n._sqlite3_str_value = pr.Va),
      (n._sqlite3_str_reset = pr.Wa),
      (n._sqlite3_str_new = pr.Xa),
      (n._sqlite3_vmprintf = pr.Ya),
      (n._sqlite3_mprintf = pr.Za),
      (n._sqlite3_vsnprintf = pr._a),
      (n._sqlite3_snprintf = pr.$a),
      (n._sqlite3_log = pr.ab),
      (n._sqlite3_randomness = pr.bb),
      (n._sqlite3_stricmp = pr.cb),
      (n._sqlite3_strnicmp = pr.db),
      (n._sqlite3_os_init = pr.eb),
      (n._sqlite3_os_end = pr.fb),
      (n._sqlite3_serialize = pr.gb),
      (n._sqlite3_prepare_v2 = pr.hb),
      (n._sqlite3_step = pr.ib),
      (n._sqlite3_column_int64 = pr.jb),
      (n._sqlite3_reset = pr.kb),
      (n._sqlite3_exec = pr.lb),
      (n._sqlite3_column_int = pr.mb),
      (n._sqlite3_finalize = pr.nb),
      (n._sqlite3_deserialize = pr.ob),
      (n._sqlite3_database_file_object = pr.pb),
      (n._sqlite3_backup_init = pr.qb),
      (n._sqlite3_backup_step = pr.rb),
      (n._sqlite3_backup_finish = pr.sb),
      (n._sqlite3_backup_remaining = pr.tb),
      (n._sqlite3_backup_pagecount = pr.ub),
      (n._sqlite3_clear_bindings = pr.vb),
      (n._sqlite3_value_blob = pr.wb),
      (n._sqlite3_value_text = pr.xb),
      (n._sqlite3_value_bytes = pr.yb),
      (n._sqlite3_value_bytes16 = pr.zb),
      (n._sqlite3_value_double = pr.Ab),
      (n._sqlite3_value_int = pr.Bb),
      (n._sqlite3_value_int64 = pr.Cb),
      (n._sqlite3_value_subtype = pr.Db),
      (n._sqlite3_value_pointer = pr.Eb),
      (n._sqlite3_value_text16 = pr.Fb),
      (n._sqlite3_value_text16be = pr.Gb),
      (n._sqlite3_value_text16le = pr.Hb),
      (n._sqlite3_value_type = pr.Ib),
      (n._sqlite3_value_encoding = pr.Jb),
      (n._sqlite3_value_nochange = pr.Kb),
      (n._sqlite3_value_frombind = pr.Lb),
      (n._sqlite3_value_dup = pr.Mb),
      (n._sqlite3_value_free = pr.Nb),
      (n._sqlite3_result_blob = pr.Ob),
      (n._sqlite3_result_blob64 = pr.Pb),
      (n._sqlite3_result_double = pr.Qb),
      (n._sqlite3_result_error = pr.Rb),
      (n._sqlite3_result_error16 = pr.Sb),
      (n._sqlite3_result_int = pr.Tb),
      (n._sqlite3_result_int64 = pr.Ub),
      (n._sqlite3_result_null = pr.Vb),
      (n._sqlite3_result_pointer = pr.Wb),
      (n._sqlite3_result_subtype = pr.Xb),
      (n._sqlite3_result_text = pr.Yb),
      (n._sqlite3_result_text64 = pr.Zb),
      (n._sqlite3_result_text16 = pr._b),
      (n._sqlite3_result_text16be = pr.$b),
      (n._sqlite3_result_text16le = pr.ac),
      (n._sqlite3_result_value = pr.bc),
      (n._sqlite3_result_error_toobig = pr.cc),
      (n._sqlite3_result_zeroblob = pr.dc),
      (n._sqlite3_result_zeroblob64 = pr.ec),
      (n._sqlite3_result_error_code = pr.fc),
      (n._sqlite3_result_error_nomem = pr.gc),
      (n._sqlite3_user_data = pr.hc),
      (n._sqlite3_context_db_handle = pr.ic),
      (n._sqlite3_vtab_nochange = pr.jc),
      (n._sqlite3_vtab_in_first = pr.kc),
      (n._sqlite3_vtab_in_next = pr.lc),
      (n._sqlite3_aggregate_context = pr.mc),
      (n._sqlite3_get_auxdata = pr.nc),
      (n._sqlite3_set_auxdata = pr.oc),
      (n._sqlite3_column_count = pr.pc),
      (n._sqlite3_data_count = pr.qc),
      (n._sqlite3_column_blob = pr.rc),
      (n._sqlite3_column_bytes = pr.sc),
      (n._sqlite3_column_bytes16 = pr.tc),
      (n._sqlite3_column_double = pr.uc),
      (n._sqlite3_column_text = pr.vc),
      (n._sqlite3_column_value = pr.wc),
      (n._sqlite3_column_text16 = pr.xc),
      (n._sqlite3_column_type = pr.yc),
      (n._sqlite3_column_name = pr.zc),
      (n._sqlite3_column_name16 = pr.Ac),
      (n._sqlite3_bind_blob = pr.Bc),
      (n._sqlite3_bind_blob64 = pr.Cc),
      (n._sqlite3_bind_double = pr.Dc),
      (n._sqlite3_bind_int = pr.Ec),
      (n._sqlite3_bind_int64 = pr.Fc),
      (n._sqlite3_bind_null = pr.Gc),
      (n._sqlite3_bind_pointer = pr.Hc),
      (n._sqlite3_bind_text = pr.Ic),
      (n._sqlite3_bind_text64 = pr.Jc),
      (n._sqlite3_bind_text16 = pr.Kc),
      (n._sqlite3_bind_value = pr.Lc),
      (n._sqlite3_bind_zeroblob = pr.Mc),
      (n._sqlite3_bind_zeroblob64 = pr.Nc),
      (n._sqlite3_bind_parameter_count = pr.Oc),
      (n._sqlite3_bind_parameter_name = pr.Pc),
      (n._sqlite3_bind_parameter_index = pr.Qc),
      (n._sqlite3_db_handle = pr.Rc),
      (n._sqlite3_stmt_readonly = pr.Sc),
      (n._sqlite3_stmt_isexplain = pr.Tc),
      (n._sqlite3_stmt_explain = pr.Uc),
      (n._sqlite3_stmt_busy = pr.Vc),
      (n._sqlite3_next_stmt = pr.Wc),
      (n._sqlite3_stmt_status = pr.Xc),
      (n._sqlite3_sql = pr.Yc),
      (n._sqlite3_expanded_sql = pr.Zc),
      (n._sqlite3_value_numeric_type = pr._c),
      (n._sqlite3_blob_open = pr.$c),
      (n._sqlite3_blob_close = pr.ad),
      (n._sqlite3_blob_read = pr.bd),
      (n._sqlite3_blob_write = pr.cd),
      (n._sqlite3_blob_bytes = pr.dd),
      (n._sqlite3_blob_reopen = pr.ed),
      (n._sqlite3_set_authorizer = pr.fd),
      (n._sqlite3_strglob = pr.gd),
      (n._sqlite3_strlike = pr.hd),
      (n._sqlite3_errmsg = pr.id),
      (n._sqlite3_load_extension = pr.jd),
      (n._sqlite3_enable_load_extension = pr.kd),
      (n._sqlite3_auto_extension = pr.ld),
      (n._sqlite3_cancel_auto_extension = pr.md),
      (n._sqlite3_reset_auto_extension = pr.nd),
      (n._sqlite3_prepare = pr.od),
      (n._sqlite3_prepare_v3 = pr.pd),
      (n._sqlite3_prepare16 = pr.qd),
      (n._sqlite3_prepare16_v2 = pr.rd),
      (n._sqlite3_prepare16_v3 = pr.sd),
      (n._sqlite3_get_table = pr.td),
      (n._sqlite3_free_table = pr.ud),
      (n._sqlite3_create_module = pr.vd),
      (n._sqlite3_create_module_v2 = pr.wd),
      (n._sqlite3_drop_modules = pr.xd),
      (n._sqlite3_declare_vtab = pr.yd),
      (n._sqlite3_vtab_on_conflict = pr.zd),
      (n._sqlite3_vtab_config = pr.Ad),
      (n._sqlite3_vtab_collation = pr.Bd),
      (n._sqlite3_vtab_in = pr.Cd),
      (n._sqlite3_vtab_rhs_value = pr.Dd),
      (n._sqlite3_vtab_distinct = pr.Ed),
      (n._sqlite3_keyword_name = pr.Fd),
      (n._sqlite3_keyword_count = pr.Gd),
      (n._sqlite3_keyword_check = pr.Hd),
      (n._sqlite3_complete = pr.Id),
      (n._sqlite3_complete16 = pr.Jd),
      (n._sqlite3_libversion = pr.Kd),
      (n._sqlite3_libversion_number = pr.Ld),
      (n._sqlite3_threadsafe = pr.Md),
      (n._sqlite3_initialize = pr.Nd),
      (n._sqlite3_shutdown = pr.Od),
      (n._sqlite3_config = pr.Pd),
      (n._sqlite3_db_mutex = pr.Qd),
      (n._sqlite3_db_release_memory = pr.Rd),
      (n._sqlite3_db_cacheflush = pr.Sd),
      (n._sqlite3_db_config = pr.Td),
      (n._sqlite3_last_insert_rowid = pr.Ud),
      (n._sqlite3_set_last_insert_rowid = pr.Vd),
      (n._sqlite3_changes64 = pr.Wd),
      (n._sqlite3_changes = pr.Xd),
      (n._sqlite3_total_changes64 = pr.Yd),
      (n._sqlite3_total_changes = pr.Zd),
      (n._sqlite3_txn_state = pr._d),
      (n._sqlite3_close = pr.$d),
      (n._sqlite3_close_v2 = pr.ae),
      (n._sqlite3_busy_handler = pr.be),
      (n._sqlite3_progress_handler = pr.ce),
      (n._sqlite3_busy_timeout = pr.de),
      (n._sqlite3_interrupt = pr.ee),
      (n._sqlite3_is_interrupted = pr.fe),
      (n._sqlite3_create_function = pr.ge),
      (n._sqlite3_create_function_v2 = pr.he),
      (n._sqlite3_create_window_function = pr.ie),
      (n._sqlite3_create_function16 = pr.je),
      (n._sqlite3_overload_function = pr.ke),
      (n._sqlite3_trace_v2 = pr.le),
      (n._sqlite3_commit_hook = pr.me),
      (n._sqlite3_update_hook = pr.ne),
      (n._sqlite3_rollback_hook = pr.oe),
      (n._sqlite3_autovacuum_pages = pr.pe),
      (n._sqlite3_wal_autocheckpoint = pr.qe),
      (n._sqlite3_wal_hook = pr.re),
      (n._sqlite3_wal_checkpoint_v2 = pr.se),
      (n._sqlite3_wal_checkpoint = pr.te),
      (n._sqlite3_error_offset = pr.ue),
      (n._sqlite3_errmsg16 = pr.ve),
      (n._sqlite3_errcode = pr.we),
      (n._sqlite3_extended_errcode = pr.xe),
      (n._sqlite3_system_errno = pr.ye),
      (n._sqlite3_errstr = pr.ze),
      (n._sqlite3_limit = pr.Ae),
      (n._sqlite3_open = pr.Be),
      (n._sqlite3_open_v2 = pr.Ce),
      (n._sqlite3_open16 = pr.De),
      (n._sqlite3_create_collation = pr.Ee),
      (n._sqlite3_create_collation_v2 = pr.Fe),
      (n._sqlite3_create_collation16 = pr.Ge),
      (n._sqlite3_collation_needed = pr.He),
      (n._sqlite3_collation_needed16 = pr.Ie),
      (n._sqlite3_get_clientdata = pr.Je),
      (n._sqlite3_set_clientdata = pr.Ke),
      (n._sqlite3_get_autocommit = pr.Le),
      (n._sqlite3_table_column_metadata = pr.Me),
      (n._sqlite3_sleep = pr.Ne),
      (n._sqlite3_extended_result_codes = pr.Oe),
      (n._sqlite3_file_control = pr.Pe),
      (n._sqlite3_test_control = pr.Qe),
      (n._sqlite3_create_filename = pr.Re),
      (n._sqlite3_free_filename = pr.Se),
      (n._sqlite3_uri_parameter = pr.Te),
      (n._sqlite3_uri_key = pr.Ue),
      (n._sqlite3_uri_boolean = pr.Ve),
      (n._sqlite3_uri_int64 = pr.We),
      (n._sqlite3_filename_database = pr.Xe),
      (n._sqlite3_filename_journal = pr.Ye),
      (n._sqlite3_filename_wal = pr.Ze),
      (n._sqlite3_db_name = pr._e),
      (n._sqlite3_db_filename = pr.$e),
      (n._sqlite3_db_readonly = pr.af),
      (n._sqlite3_compileoption_used = pr.bf),
      (n._sqlite3_compileoption_get = pr.cf),
      (n._sqlite3_sourceid = pr.df),
      (n._sqlite3mc_config = pr.ef),
      (n._sqlite3mc_cipher_count = pr.ff),
      (n._sqlite3mc_cipher_index = pr.gf),
      (n._sqlite3mc_cipher_name = pr.hf),
      (n._sqlite3mc_config_cipher = pr.jf),
      (n._sqlite3mc_vfs_create = pr.kf));
   var hr = (n._malloc = pr.lf),
      vr = (n._free = pr.mf);
   ((n._RegisterExtensionFunctions = pr.nf), (n._getSqliteFree = pr.of));
   var yr = (n._main = pr.pf);
   ((n._libauthorizer_set_authorizer = pr.qf),
      (n._libfunction_create_function = pr.rf),
      (n._libhook_commit_hook = pr.sf),
      (n._libhook_update_hook = pr.tf),
      (n._libprogress_progress_handler = pr.uf),
      (n._libvfs_vfs_register = pr.vf));
   var wr = pr.xf,
      br = pr.yf,
      gr = pr.zf,
      Er = pr.Af,
...
export { e as default };
//# sourceMappingURL=mc-wa-sqlite-async-lGclTjKJ.js.map
